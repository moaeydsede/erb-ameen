...
async function save(){
  ...
  await upsert("invoices",null,{type:"sales_return",date,day,customerId,discount,total,net,cogs,lines:enriched});
  // حركة مخزون (IN)
  for(const l of enriched){
    await upsert("inventoryMoves",null,{date,day,type:"in",reason:"sales_return",itemId:l.itemId,qty:l.qty,unitCost:l.avgCost,ref:""});
  }
