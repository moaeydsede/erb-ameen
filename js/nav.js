...
const GROUPS=[
 ...
 {label:"فواتير",ico:"file",perm:"invoices",items:[
  ...
  {href:"purchases.html",label:"فواتير مشتريات",sub:"بنود + خصم مكتسب",ico:"file",perm:"invoices"},
  {href:"purchase-return.html",label:"مرتجع مشتريات",sub:"إرجاع + حركة مخزون",ico:"file",perm:"invoices"},
  {href:"sales-return.html",label:"مرتجع مبيعات",sub:"إرجاع + حركة مخزون",ico:"file",perm:"invoices"},
 ]},
 {label:"التصنيع",ico:"factory",perm:"manufacturing",items:[
  ...
  {href:"cost-card.html",label:"بطاقة تكاليف",sub:"مواد أولية + مصاريف + جاهز",ico:"factory",perm:"manufacturing"},
 ]},
 {label:"سندات",ico:"receipt",perm:"vouchers",items:[
  {href:"receipt.html",label:"سند قبض",sub:"متعدد الحسابات",ico:"receipt",perm:"vouchers"},
  {href:"payment.html",label:"سند دفع",sub:"متعدد الحسابات",ico:"receipt",perm:"vouchers"},
  {href:"fx.html",label:"سند تحويل عملات",sub:"سعر صرف + مكافئ",ico:"receipt",perm:"vouchers"},
 ...
 {label:"تقارير",ico:"chart",perm:"reports",items:[
  ...
  {href:"balances.html",label:"تقرير الأرصدة",sub:"مدين/دائن/رصيد",ico:"chart",perm:"reports"},
  {href:"statement.html",label:"كشف حساب",sub:"فلترة + طباعة",ico:"chart",perm:"reports"},
  {href:"statement-detail.html",label:"كشف حساب تفصيلي",sub:"يشمل بنود الفواتير",ico:"chart",perm:"reports"},
  {href:"remaining-customers.html",label:"متبقي العملاء",sub:"بحث + طباعة",ico:"chart",perm:"reports"},
  {href:"remaining-suppliers.html",label:"متبقي الموردين",sub:"بحث + طباعة",ico:"chart",perm:"reports"},
  {href:"ledger.html",label:"دفتر الأستاذ",sub:"قيود مجمعة",ico:"chart",perm:"reports"},
...
renderGroups(); renderBottom();
  ...
  {href:"cheques.html",label:"الشيكات",sub:"قبض/دفع",ico:"doc",perm:"vouchers"},
  {href:"cheques-dashboard.html",label:"متابعة الشيكات",sub:"المتبقي والتظهير",ico:"chart",perm:"vouchers"},
  {href:"cheques-due.html",label:"شيكات مستحقة",sub:"خلال 7 أيام",ico:"chart",perm:"vouchers"},
  {href:"cheques-analytics.html",label:"تحليلات الشيكات",sub:"مصدر/وجهة",ico:"chart",perm:"vouchers"},
