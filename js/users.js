...
let cache=[];
const KEYS=["company","accounts","invoices","manufacturing","vouchers","reports","cfo"];
const T={viewer:{company:false,accounts:false,invoices:false,manufacturing:false,vouchers:false,reports:false,cfo:false},
sales:{company:false,accounts:false,invoices:true,manufacturing:false,vouchers:true,reports:false,cfo:false},
